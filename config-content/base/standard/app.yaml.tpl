...
CRYPTO_MODE: '{{ required ".Values.vertx.cryptoMode required!" .Values.vertx.cryptoMode }}'
...
REST_VERSION: '{{ required ".Values.app.apiVersion required!" .Values.app.apiVersion }}'
