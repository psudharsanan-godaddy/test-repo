...
roles:
  {{- $additionalSuperRoleRoutes := include "commerce-app-v2.appSpecificConfigBlock" (merge (dict "configType" "auth" "blockName" "additional-super-role-routes") .) }}
  ...
  {{- $additionalWriteRoleRoutes := include "commerce-app-v2.appSpecificConfigBlock" (merge (dict "configType" "auth" "blockName" "additional-write-role-routes") .) }}
  ...
  {{- $additionalReadRoleRoutes := include "commerce-app-v2.appSpecificConfigBlock" (merge (dict "configType" "auth" "blockName" "additional-read-role-routes") .) }}
  ...
  {{- $additionalJournalRoleRoutes := include "commerce-app-v2.appSpecificConfigBlock" (merge (dict "configType" "auth" "blockName" "additional-journal-role-routes") .) }}
  ...
  utility:
    ...
    {{- $additionalUtilityRoleRoutes := include "commerce-app-v2.appSpecificConfigBlock" (merge (dict "configType" "auth" "blockName" "additional-utility-role-routes") .) }}
  ...
  {{- $additionalRoles := include "commerce-app-v2.appSpecificConfigBlock" (merge (dict "configType" "auth" "blockName" "additional-roles") .) }}
...
profiles:
  ...
  {{- $additionalProfiles := include "commerce-app-v2.appSpecificConfigBlock" (merge (dict "configType" "auth" "blockName" "additional-profiles") .) }}
