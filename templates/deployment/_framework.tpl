...
{{- template "commerce-app-v2.deployment.vertx.env" (merge  (dict "cacertsSecretName" .cacertsSecretName "storeKeysSecretName" .storeKeysSecretName) .)}}
{{- else if eq .Values.app.frameworkType "spring-boot" }}
{{- template "commerce-app-v2.deployment.spring-boot.env" (merge  (dict "cacertsSecretName" .cacertsSecretName "storeKeysSecretName" .storeKeysSecretName) .) }}
{{- end }}
